...
function renderAuthScreen() {
  render(`
    <div class="auth-character-wrap">
      <img class="auth-character-img" src="assets/default-male.png" alt="" />
      ${renderStarField(18, true)}
      <div class="auth-gradient-overlay"></div>
      <div class="auth-form-layer">
        <h1 style="margin-bottom:4px;">Discipline</h1>
...
function openCharacterSelect(returnTo) {
  ...
  render(`
    <div class="page-content">
      ...
      <p style="color:var(--text-secondary); margin-bottom:16px;">Choose your default character. Upload-your-own is coming soon.</p>
      ...
      <div class="char-upload-row">
        <div class="char-upload-label">Upload Your Own — coming soon</div>
      </div>
    </div>`);
}
...
// ===== GENDER SELECT (onboarding step 0) =====
function renderGenderSelect() {
  render(`
    <div class="page-content">
      <p class="subtext" style="margin-top:40px;">Step 0 of 4</p>
      ...
      <div class="gender-option-list">
        <div class="option-item" onclick="selectGenderAndContinue('male')">Male</div>
        <div class="option-item" onclick="selectGenderAndContinue('female')">Female</div>
        <div class="option-item" onclick="selectGenderAndContinue('male')">Prefer not to say</div>
      </div>
    </div>`);
}

async function selectGenderAndContinue(gender) {
  render(`<div class="loading">Saving...</div>`);
